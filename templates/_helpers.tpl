...
*/}}
{{- define "pet2cattle.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "pet2cattle.fullname" .) .Values.serviceAccount.name }}
{{- else }}
